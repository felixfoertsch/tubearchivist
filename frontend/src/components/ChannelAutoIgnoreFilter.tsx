  ...
  return (
    <div className="info-box">
      <div className="info-box-item">
        ...
        <p>
          Example: <code>PODCAST: The Joy of Why</code> ignores titles containing that phrase.
        </p>
        <p>
          To format a pattern across multiple lines, start with <code>(?x)</code>. Whitespace is
          then ignored; use <code>\s</code> to match spaces in titles.
        </p>
